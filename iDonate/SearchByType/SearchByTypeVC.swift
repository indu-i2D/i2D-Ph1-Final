...
import UIKit
 ...
 ///SearchByTypeVC: A view controller for searching by type in the iDonate application.
 
 ///This view controller allows users to search for organizations based on predefined types such as arts, education, environment, etc.
